...
var CharacterControls = /** @class */ (function () {
  function CharacterControls(model, mixer, animationsMap, orbitControl, camera, currentAction) {
    this.animationsMap = new Map(); // Walk, Run, Survey
    // state
    this.toggleRun = true;
    // temporary data
  ...
  CharacterControls.prototype.update = function (delta, keysPressed) {
    ...
    if (this.currentAction == "Run" || this.currentAction == "Walk") {
      ...
      this.rotateQuarternion.setFromAxisAngle(
        this.rotateAngle,
        angleYCameraDirection + directionOffset + 600
      );
