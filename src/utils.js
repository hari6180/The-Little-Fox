...
var KeyDisplay = /** @class */ (function () {
    ...
    KeyDisplay.prototype.updatePosition = function () {
        this.map.get(exports.W).style.top = window.innerHeight - 150 + "px";
        ...
        this.map.get(exports.W).style.left = 300 + "px";
        this.map.get(exports.A).style.left = 200 + "px";
        this.map.get(exports.S).style.left = 300 + "px";
        this.map.get(exports.D).style.left = 400 + "px";
